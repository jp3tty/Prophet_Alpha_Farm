...
class StockForecaster:
    def __init__(self, csv_path):
        ...
        self.param_grid = {
            ...
            'seasonality_prior_scale': [0.01, 100.0],
            'holidays_prior_scale': [0.01, 100.0],
            'seasonality_mode': ['additive', 'multiplicative'],
            'interval_width': [0.6, 0.95],
...
def main():
    ...
    try:
        ...
        forecaster.test_hyperparameters(baseline_mse, 'hyperparameter_results_rev2.csv')
