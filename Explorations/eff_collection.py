...
# Example usage
tickers = ['AAPL', 'TSLA', 'AMD', 'NVDA', 'BAC', 'F', 'PLTR', 'INTC', 'AMZN', 'META', 'NIO', 'SOFI', 'CCL', 'AAL', 'VALE', 'MSFT', 'PFE', 'GOOGL', 'KO', 'T', 'WBD', 'SNAP', 'UBER', 'GM', 'XOM', 'PYPL', 'VZ', 'LCID', 'HOOD', 'WFC', 'BABA', 'DIS', 'JPM', 'RIVN', 'C', 'GOOG', 'PBR', 'CSCO', 'NFLX', 'SHOP', 'JD', 'NOK', 'NU', 'DNA', 'COIN', 'PLUG', 'LYFT', 'PINS', 'LUMN', 'FSR'] # Stock inputs
metrics_df, returns_df = analyze_stocks(tickers, period='1y')          # Output directory and time period can be added: metrics_df, returns_df = analyze_stocks(tickers, period='2y', output_dir='my_analysis')
